...
twist = Twist()
goal_list = [
    rospy.wait_for_message('/id500/aruco_single/pose', PoseStamped),
    rospy.wait_for_message('/id502/aruco_single/pose', PoseStamped),
    rospy.wait_for_message('/id503/aruco_single/pose', PoseStamped),
    rospy.wait_for_message('/id505/aruco_single/pose', PoseStamped)
]
for goal_pose in goal_list:
